/**
 * Example form RxJava http://reactivex.io/intro.html
 */
...
public class FuturesB {
    ...
    public static void main(String args[]) {
        try {
            ...
            run2();
            System.out.println("Finished run2 in: " + (System.currentTimeMillis() - start) + "ms");
            start = System.currentTimeMillis();
            run3();
            System.out.println("Finished run3 in: " + (System.currentTimeMillis() - start) + "ms");
            start = System.currentTimeMillis();
            run4();
            System.out.println("Finished run4 in: " + (System.currentTimeMillis() - start) + "ms");
            start = System.currentTimeMillis();
            run5();
            System.out.println("Finished run5 in: " + (System.currentTimeMillis() - start) + "ms");
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
